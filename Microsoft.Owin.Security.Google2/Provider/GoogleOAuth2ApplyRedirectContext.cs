...
namespace Microsoft.Owin.Security.Google2
{
    ...
    public class Google2OAuth2ApplyRedirectContext : BaseContext<Google2OAuth2AuthenticationOptions>
    {
        /// <summary>
        ...
        public Google2OAuth2ApplyRedirectContext(IOwinContext context, Google2OAuth2AuthenticationOptions options, 
