...
namespace Microsoft.Owin.Security.Google2
{
    ...
    public class Google2OAuth2AuthenticatedContext : BaseContext
    {
        /// <summary>
        /// Initializes a <see cref="Google2OAuth2AuthenticatedContext"/>
        /// </summary>
        ...
        public Google2OAuth2AuthenticatedContext(IOwinContext context, JObject user, string accessToken, 
        ...
        public Google2OAuth2AuthenticatedContext(IOwinContext context, JObject user, JObject tokenResponse)
            : base(context)
        {
            User = user;
